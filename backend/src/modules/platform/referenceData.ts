export const ROLE_SEEDS = [
  ...
  {
    code: 'billing_staff',
    description: 'Restricted billing workspace staff',
    name: 'Billing Staff',
  },
  {
    code: 'case_staff',
    description: 'Assigned-matter internal case staff',
    name: 'Case Staff',
  },
  {
    code: 'advocate',
    description: 'Assigned-matter external advocate',
    name: 'Advocate',
  },
  {
    code: 'ops_admin',
...
export const PERMISSION_SEEDS = [
  ...
  ['matter.view_assigned', 'matter', 'view_assigned', 'View assigned matters'],
  ['matter.update', 'matter', 'update', 'Update matters'],
  ['matter.update_assigned', 'matter', 'update_assigned', 'Update assigned matters'],
  ['document.view', 'document', 'view', 'View documents'],
  ['document.view_assigned', 'document', 'view_assigned', 'View assigned matter documents'],
  ['document.manage', 'document', 'manage', 'Manage documents'],
  [
    'document.download_assigned',
    'document',
    'download_assigned',
    'Download assigned matter documents',
  ],
  ['message.view', 'message', 'view', 'View message threads'],
  ['message.view_assigned', 'message', 'view_assigned', 'View assigned matter message threads'],
  ['message.send', 'message', 'send', 'Send thread messages'],
  ['message.send_assigned', 'message', 'send_assigned', 'Send messages on assigned matters'],
  ...
  ['event.view_assigned', 'event', 'view_assigned', 'View assigned matter events'],
...
export const ROLE_PERMISSION_SEEDS: Array<[string, string[]]> = [
  ...
  ['billing_staff', ['invoice.view', 'payment.view', 'refund.view']],
  [
    'case_staff',
    [
      'client_account.view_assigned',
